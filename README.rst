...
#. (*NOT RECOMMENDED*) place your SQLite database inside your package and
   ...
   (Please note resources are supposed to be immutable and not re-written to
   disk)
...
to create separated folder for top-level applications inside the same project,
this is more or less incompatible with the concept of a Python package...
...
them and declare them as dependencies of your main project (basically `python
manage.py startapp` should not be used together with PyScaffold).
...
#. Accept configurations via environment variables, and throw meaningful errors
   ...
   file, you can always let the final user of your package to specify a
...
#. Be extra careful with secrets and confidential info **in general**.
   ...
   permissions). Instructing your users to create a separated system account to
   run your web app, with limited privileges might also be good.
...
.. _package data:
   https://pyscaffold.org/en/latest/features.html#configuration-packaging-distribution
